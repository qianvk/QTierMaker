...
inline constexpr QStringView overviewBackdropEffect = u"overview/backdropEffect";
inline constexpr QStringView previewBackgroundMode = u"preview/backgroundMode";
inline constexpr QStringView previewEffect = u"preview/effect";
// Keep pixel-valued geometry separate from the legacy fractional setting.
inline constexpr QStringView liquidGlassCornerRadius = u"liquidGlass/cornerRadiusPixels";
inline constexpr QStringView liquidGlassBlurRadius = u"liquidGlass/blurRadius";
inline constexpr QStringView liquidGlassRefractionHeight = u"liquidGlass/refractionHeight";
inline constexpr QStringView liquidGlassRefractionAmount = u"liquidGlass/refractionAmount";
inline constexpr QStringView liquidGlassChromaticAberration =
    u"liquidGlass/chromaticAberration";
